...
const Navbar = () => {
  ...
  return (
    ...
    justify-between z-50 ${isScroll ? "bg-white/50 backdrop-blur-lg shadow-sm ":""}`}>
      ...
      <ul className={`hidden md:flex items-center justify-between gap-6 lg:gap-8
      ...
      <ul ref={sideMenuRef} className='flex md:hidden flex-col gab-4 py-20 px-10 fixed -right-64 top-0 bottom-9 w-64 
